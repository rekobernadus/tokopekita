	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : (+6285) 752 367 076</li>
				</ul>
			</div>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Reko bernadus's Lab, pontianak.</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:rekobernadus@gmail.com">rekobernadus@email.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>(+628) 575 236 7076</li>
					</ul>
				</div>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2022 Reko bernadus's Lab. All rights reserved</p>
			</div>
		</div>
